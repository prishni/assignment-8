...
training_data = na.omit( mv[1:4000,-c(17,10,22)])

test_data = na.omit(data.frame(mv[4001:nrow(mv),-c(17,10,22)]) )
...
model1  = lm(formula = formula1 , data = training_data , na.action = na.pass)
